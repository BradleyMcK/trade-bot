...
public class DBB extends CandlestickIndicator {

    public DBB(Symbol symbol, Duration duration) {
    ...
    /*
    public DBB(String asset, String symbol, CandlestickInterval interval) {
