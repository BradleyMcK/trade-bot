...
public class MACD extends CandlestickIndicator {

    public MACD(Symbol symbol, Duration duration) {
    ...
    /*
    public MACD(String asset, String symbol, CandlestickInterval interval) {
